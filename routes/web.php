...
Route::middleware(['auth','verified'])->group(function() {
    ...
    Route::post('/tvshows/request', [TVShowRequestController::class, 'store'])->name('tvshowsrequest.store');
    ...
    Route::delete('/tvshows/delete/{tvshow}', [TVShowController::class, 'destroy'])->name('tvshows.destroy');

    Route::get('/movies', [MovieController::class, 'index'])->name('movies.index');
    Route::get('/movies/request', [MovieRequestController::class, 'create'])->name('moviesrequest.request');
    Route::post('/movies/request', [MovieRequestController::class, 'store'])->name('moviesrequest.store');
